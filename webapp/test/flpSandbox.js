		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pie Chart",
									"targetURL": "#piechartv2piechart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"piechartv2piechart-display": {
								"semanticObject": "piechartv2piechart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pie.chart.v2.pie.chart",
									"url": sap.ui.require.toUrl("pie/chart/v2/pie/chart")
								}
							}
						}
					}
